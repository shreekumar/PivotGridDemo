...
@Component({
  selector: 'app-data-binding-large',
  templateUrl: './data-binding-large.component.html',
  styleUrls: ['./data-binding-large.component.css']
})
export class DataBindingLargeComponent implements OnInit {
