...
@Component({
  ...
  styleUrls: ['./custom-rendering.component.css']
})
export class CustomRenderingComponent implements OnInit {
  ngOnInit(): void {  }
  constructor() {
  ...
  myItemsRenderer(pivotItem): string {
    ...
    return "<div style='background: " + backgroundColor + "; padding: 4px;'>" + pivotItem.text + sortElement + "</div>";
  }
  ...
  myCellsRenderer(pivotCell): string {
    ...
    return "<div style='background: " + backgroundColor + ";  height: 100%; padding: 4px; margin: 0px;'>" + cellText + "</div>";
  }
